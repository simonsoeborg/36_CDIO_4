        ...
        switch (n) {
            case 6:
                if (case6Count < 2) {
                    ...
                    newChanceCard = reader.read(4, 6);
                    case6Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
                }
                break;
            case 12:
                if (case12Count < 2) {
                    newChanceCard = reader.read(4, 12);
                    case12Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 13:
                if (case13Count < 3) {
                    newChanceCard = reader.read(4, 13);
                    case13Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 17:
                if (case17Count < 2) {
                    newChanceCard = reader.read(4, 17);
                    case17Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 24:
                if (case24Count < 2) {
                    newChanceCard = reader.read(4, 24);
                    case24Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 26:
                if (case26Count < 2) {
                    newChanceCard = reader.read(4, 26);
                    case26Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 28:
                if (case28Count < 2) {
                    newChanceCard = reader.read(4, 28);
                    case28Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 35:
                if (case35Count < 2) {
                    newChanceCard = reader.read(4, 35);
                    case35Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
            ...
            case 36:
                if (case36Count < 2) {
                    newChanceCard = reader.read(4, 36);
                    case36Count++;
                } else {
                    // Draw new card
                    newChanceCard = reader.read(4, rand.nextInt(MAX +1));
